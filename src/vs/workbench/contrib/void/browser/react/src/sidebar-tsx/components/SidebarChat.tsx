...
import { ProseWrapper } from '../ui/ProseWrappers.js';
import { VoidChatArea } from '../ui/VoidChatArea.js';
import { EditToolSoFar } from '../tools/EditTool.js';
...
const ScrollToBottomContainer = ({ children, className, style, scrollContainerRef }: {
